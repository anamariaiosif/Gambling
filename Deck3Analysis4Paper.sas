...
* STUDY        : 	COCOA                                                 			    	*;
*                                                                                          	*;
* PROGRAM      : 	Deck3Analysis4Paper.sas                                                 		*;
*                                                                                       	*;
...
*********************************************************************************************;
*********************************************************************************************;
footnote "GAMBLING\Iowa Gambling\Deck 3" ; 
...
proc glimmix data=long1 maxopt=1000;
title 'Logistic model, block categorical, without NS interactions';
   class subid  group01(ref="0") block(ref="1") ;
model deck3/n = block  age_c|fsiqc  group01|fsiqc fsiqc*fsiqc|group01/ solution ddfm=kr;
